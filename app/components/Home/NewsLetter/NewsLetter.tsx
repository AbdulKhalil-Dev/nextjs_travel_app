...
const NewsLetter = () => {
  return (
    <div className='bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col'>
      ...
      <p className='mt-3 text-white text-xs sm:text-sm'>Sign up and we&apos;ll send the best deals to ypu</p>
      ...
      <div className='w-full'>
        ...
        <button className='px-6 py-3.5 bg-blue-900 text-white hover:bg-blue-950 transition-all duration-200 mt-4 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none'>Subscribe</button>
      </div>
    </div>
  )
}
